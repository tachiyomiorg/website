...
## How can I make my new install of Tachiyomi detect my downloads?
...
## How can I upload or sync my backups elsewhere?

While Cross Device Sync is not planned for Tachiyomi, you can sync your backups to other places using external apps like [AutoSync for Google Drive](https://play.google.com/store/apps/details?id=com.ttxapps.drivesync) or [Syncthing](https://play.google.com/store/apps/details?id=com.nutomic.syncthingandroid).
