...
import { IconBugReport, IconDownload, IconNewspaperVariant, IconPlaylistRemove } from '@iconify-prerendered/vue-mdi'
...
export default {
  ...
  enhanceApp({ app }) {
    ...
    app.component('IconPlaylistRemove', IconPlaylistRemove)
